defmodule ClarxLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClarxLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClarxLiveWeb.Gettext, "errors", msg, opts)
    end
  end
